          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  decoration: InputDecoration(
                    hintText: "Type of product Dealing (Gents,Ladies,Kids..,)",
                    hintStyle: GoogleFonts.poppins(
                      textStyle: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w500,
...
class _CustomerRegisterPageState extends State<CustomerRegisterPage> {
  ...
  String _preferrerdTransport = '';
  String _referedby = '';
  String _referalcode = '';
  String _noofBranches = '';
  String _productDealing = '';
  String _yearsInBusiness = '';
  String _socialMediaIds = '';
  final url = Uri.parse(Uri.encodeFull(
      '$http_key://$core_url/api/resource/Customer Registration'));
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    final data = {
      ...
      'email_id': _emailid,
      'pre_trasport': _preferrerdTransport,
      'ref_by': _referedby,
      'ref_code': _referalcode,
      'no_of_branch': _noofBranches,
      'yearly_turnover': _annualTurnover,
      'type': _productDealing,
      'years': _yearsInBusiness,
      'website': _socialMediaIds,
    };
    print(data);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    decoration: InputDecoration(
                      hintText:
                          "Type of product Dealing (Gents,Ladies,Kids..,)",
                      hintStyle: GoogleFonts.poppins(
                        textStyle: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w500,
                    ...
                    onSaved: (value) => _productDealing = value,
                    validator: (value) {
                      if (value.isEmpty) {
                        return 'Please enter your Type of product Dealing';
                      }
                      return null;
                    },
                  ),
                ...
                _buildTextFormField(
                  ...
                  onSaved: (value) => _preferrerdTransport = value,
                  validator: (value) {
                    if (value.isEmpty) {
                ...
                _buildTextFormField(
                  hintText: "Refered by",
                  onSaved: (value) => _referedby = value,
                  validator: (value) {
                    if (value.isEmpty) {
                      return 'Please enter your Refered by';
                    }
                    return null;
                  },
                ),
                _buildTextFormField(
                  ...
                  onSaved: (value) => _referalcode = value,
                  validator: (value) {
                    if (value.isEmpty) {
                      return 'Please enter your Referal code';
                    }
                    return null;
                  },
                ),
                _buildTextFormField(
                  hintText: "Number of Branch's",
                  onSaved: (value) => _noofBranches = value,
                  // validator: (value) {
                  //   if (value.isEmpty) {
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    onSaved: (value) => _yearsInBusiness = value,
                  ),
                ),
                _buildTextFormField(
                  hintText: "Annual Turnover",
                  onSaved: (value) => _annualTurnover = value,
                  // validator: (value) {
                  //   if (value.isEmpty) {
                  //     return 'Please enter your annual turnover';
                  //   }
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    onSaved: (value) => _socialMediaIds = value,
                  ),
                ),
                const SizedBox(
                  height: 20,
  ...
  void _submitForm() {
    if (_formKey.currentState.validate()) {
      ...
      print('Annual Turnover: $_annualTurnover');
      print('Type of product Dealing: $_productDealing');
      print('Years In Business: $_yearsInBusiness');
      print('Social Media ID\'s: $_socialMediaIds');
    }
  }
}
