...
class MyListView extends StatefulWidget {
  ...
  const MyListView({Key key, this.dataList}) : super(key: key);
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return ListTile(
              ...
              subtitle: Text(
                'Size: ${widget.dataList[index]['size']} Qty: ${widget.dataList[index]['qty']} Rate: ${widget.dataList[index]['rate']} ',
              ),
              trailing: Row(
...
class MyMainWidget extends StatefulWidget {
  ...
  @override
  _MyMainWidgetState createState() => _MyMainWidgetState();
}
        ...
        appBar: AppBar(
            ...
            actions: [
              ...
              /*   ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      Colors.orange, // Set the background color to orange 200
                ),
                onPressed: () {
                  showDialog(
                    context: context,
